...
interface GlowCardProps {
  children?: ReactNode;
  className?: string;
  glowColor?: "blue" | "purple" | "green" | "red" | "orange" | "lime" | "teal";
  size?: "sm" | "md" | "lg";
  width?: string | number;
...
const glowColorMap = {
  ...
  lime:   { base: 75,  spread: 180 },
  teal:   { base: 174, spread: 160 },
};
  ...
  return (
    <>
      ...
      <div
        ...
        className={`${sizeClass} ${!customSize ? "aspect-[3/4]" : ""} rounded-2xl relative grid grid-rows-[1fr_auto] shadow-[0_1rem_2rem_-1rem_black] p-4 gap-4 backdrop-blur-[5px] ${className}`}
      >
